...
@section('page')
    <div class="space-y-16 my-16 lg:w-2/3">
        <p>
            Ai sensi dell’art. 13 del D.lgs.196/03 ed in seguito all’entrata in vigore del Regolamento UE nr. 679/2016
            conformemente a quanto disciplinato dall’art. 13 del citato Regolamento Europeo, desideriamo comunicarVi
            quanto segue:
        </p>

        @foreach(Lang::get('privacy') as $section)
            <section>
                <h2 class="title-lg">
                    {{ $section["title"] }}
                </h2>
        ...
        @endforeach
        {{--            <x-half-section title="Finalità del trattamento">--}}
        ...
        {{--            </x-half-section>--}}
        {{--            <x-half-section title="Modalità del trattamento">--}}
        ...
        {{--            </x-half-section>--}}
        {{--            <x-half-section title="Base giuridica del trattamento">--}}
        {{--                La base giuridica del trattamento dei Vs. dati personali si fonda sulla registrazione al portale web https://www.talkingteens.it.--}}
        ...
        {{--            </x-half-section>--}}
        {{--            <x-half-section title="Comunicazione dei dati a terzi">--}}
        ...
        {{--            </x-half-section>--}}
        {{--            <x-half-section title="Tempi di conservazione">--}}
        {{--                I Vs. dati personali saranno conservati per nr. 10 anni, dalla cessazione del rapporto di erogazione del servizio/di fornitura del prodotto presso gli archivi informatici di proprietà di ECHO - Education Culture Human Oxygen.--}}
        {{--            </x-half-section>--}}
        {{--            <x-half-section title="Intenzione del Titolare del trattamento dati personali">--}}
        {{--                Il Titolare del trattamento non trasferirà i Vs. dati personali ad un paese terzo o ad una organizzazione internazionale.--}}
        {{--            </x-half-section>--}}
        {{--            <x-half-section title="Titolare e Responsabile del trattamento">--}}
        {{--                Titolare del trattamento dei dati è la ECHO - Education Culture Human Oxygen. Dati contatti del Titolare del trattamento, mail : team@talkingteens.it--}}
