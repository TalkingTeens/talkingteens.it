<footer class="bg-nd text-white py-16">
    <div class="max-w-7xl w-11/12 mx-auto text-sm grid gap-16">
        <div class="flex justify-between items-center gap-10">
            ...
            <div class="flex items-center gap-2 rounded-lg hover:bg-white/10 px-4 py-3 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 512 512">
                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M48 112h288M192 64v48M272 448l96-224 96 224M301.5 384h133M281.3 112S257 206 199 277 80 384 80 384"/>
        ...
        <div class="flex items-center gap-16">
            <div class="flex justify-between items-center gap-10">
                <a href="https://www.facebook.com/talkingteensparma/" target="_blank" class="hover:text-[#4267b2] transition-colors">
                ...
                <a href="https://www.instagram.com/talkingteens_parma/" target="_blank" class="hover:text-pink-500 transition-colors">
                    <svg class="h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
