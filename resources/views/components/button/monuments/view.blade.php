...
>
    ...
    <button type="button" class="absolute bottom-10 left-1/2 -translate-x-1/2 rounded-full shadow-lg bg-st cursor-pointer inline-block py-3 px-4">
        <div
            x-cloak x-show="view === 'list'"
            @click="view = 'map'"
