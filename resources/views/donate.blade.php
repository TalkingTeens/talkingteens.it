...
@section('content')
    <div x-data="{ active : 0, method: '', max : 0 }"
         x-init="$watch('active', value => max = active > max ? active : max)"
         class="grid sm:grid-cols-2 sm:h-[calc(100vh-var(--nav-height))]">
        <img src="{{ asset('/images/sponsor.jpg') }}" alt="" class="h-full w-full object-cover">
        <div>
